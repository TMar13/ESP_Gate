...
List of files:
- YAML code with two states, "open" and "closed": some gate provide the states "opening" and "closing": the code needs to be modified
...
2 relais de contrôle pour ouverture et ouverture partielle
2 états 24 V DC-AV - s'adapte à une autre tension en ajustant R1 et R2 (10 mA de polarisation de l'optocoupleur). Une entrée à contact sec est supportée sur B3 (utiliser 2 jumpers) : voir implantation.jpg
2 boutons de commande pour ouverture et ouverture partielle
1 ESP 8266 de pilotage

Liste des fichiers :
- code YAML avec 2 états "ouvert" et "fermé" : certains portails fournissent les états ouverture et fermeture : le code est à modifier
